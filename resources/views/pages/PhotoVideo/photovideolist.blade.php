            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
                ...
                <div class="bg-white rounded-3xl shadow-xl overflow-hidden border border-gray-100 group transition-all duration-500 hover:-translate-y-3 hover:shadow-2xl">
                    <div class="h-64 overflow-hidden relative">
                        <img src="{{ asset('storage/image_photography/' . $photo->image_url) }}" alt="{{ $title }}" class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110">
