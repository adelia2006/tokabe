                                                            ...
                                                            @foreach ($photography as $row)
                                                                <tr>
                                                                    ...
                                                                    <td
                                                                        ...
                                                                        {!! Str::limit(is_array($row->title) ? ($row->title['id'] ?? '') : $row->title, 10, '...') !!}
                                                                    </td>
                                                                    <td
                                                                        style="white-space: normal; word-wrap: break-word; max-width: 300px;">
                                                                        {!! Str::limit(is_array($row->description) ? ($row->description['id'] ?? '') : $row->description, 10, '...') !!}
                                                                    </td>
                                                                    <td>
                                                                        @if ($row->image_url)
                                                                            <img src="{{ asset('storage/image_photography/' . $row->image_url) }}"
                                                                                alt="{{ is_array($row->title) ? ($row->title['id'] ?? '') : $row->title }}"
