    ...
    <main>
        ...
        <div class="relative w-full h-[50vh] md:h-[60vh] bg-gray-900 overflow-hidden">
            <div class="absolute inset-0">
                <img src="{{ $lokasiooh->gambar ? asset('storage/image_lokasiooh/' . $lokasiooh->gambar) : 'https://images.unsplash.com/photo-1556761175-b413da4baf72?q=80&w=1200&auto=format&fit=crop' }}" alt="{{ $namaLokasi }}" class="w-full h-full object-cover opacity-60">
